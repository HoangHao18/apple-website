    ...
    <group name="lights">
      ...
      <Environment resolution={256}>
        <group>
           ...
           */}
          <Lightformer //~ Nguồn sáng phẳng ~ tạo reflection/phản chiếu giả lập
            form="rect"
            intensity={10}
            position={[-1, 0, -10]}
            scale={10}
            color={'#495057'} // xám đậm lạnh
          />
          <Lightformer
            form="rect"
            intensity={10}
      ...
      <spotLight
        position={[-2, 10, 5]}
        angle={0.15} // Góc mở của nón ánh sáng (0.15 rad ≈ 8.6°)
        penumbra={1} // Mức độ mờ dần ở rìa vùng sáng (0 = rìa cứng, 1 = rìa rất mờ)
        decay={0} // Mức độ ánh sáng giảm dần theo khoảng cách
        intensity={Math.PI * 0.2} //  Độ sáng của đèn
        color={'#f8f9fa'} // Màu ánh sáng
      />
      <spotLight
        position={[0, -25, 10]}
        angle={0.15}
